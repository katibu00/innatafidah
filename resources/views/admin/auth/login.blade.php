...
<head>
    ...
    <meta charset="utf-8" />
    <title>Inna-Tafidah-Boya Foundation - Admin Login</title>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card overflow-hidden">
                        <div class="bg-login text-center">
                            ...
                            <div class="position-relative">
                                ...
                                <p class="text-white-50 mb-0">Sign in to continue to Inna-Tafidah-Boya Foundation.</p>
                    ...
                    <div class="mt-3 text-center">
                        ...
                        <p>©
                            <script>document.write(new Date().getFullYear())</script> Inna-Tafidah-Boya Foundation
                        </p>
                    </div>
